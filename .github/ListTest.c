...
/* ------------------------------------- */
/* Tests para listas enlazadas simples (List_int) */
/* ------------------------------------- */

START_TEST(test_list_create) {
    List_int* list = list_int_create();
    ck_assert_ptr_nonnull(list);
    ck_assert_ptr_null(list->head);  // Cabeza debe ser NULL en una lista simple vacía
    ck_assert_ptr_null(list->tail);  // Cola también debe ser NULL
...
Suite* linked_list_suite(void){
    Suite* s = suite_create("Simple Linked List");
